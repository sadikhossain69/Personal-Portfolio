...
const Skills = () => {
    return (
        <section className='my-10'>
            ...
            <div className='grid grid-cols-1 gap-5 md:px-10'>
                <div>
                    <h2 className='text-3xl font-bold'>Expertise:</h2>
                    <p className='space-x-3 space-y-1 my-2'>
                ...
                <div>
                    <h2 className='text-3xl font-bold'>Comfortable:</h2>
                    <p className='space-x-3 space-y-1 my-2'>
                ...
                <div>
                    <h2 className='text-3xl font-bold'>Familiar:</h2>
                    <p className='space-x-3 space-y-1 my-2'>
